        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ url('dashboard/user') }}">User</a></div>
                    <div class="breadcrumb-item active">{{$user->name}}</a></div>
                </div>
            </div>
                ...
                <div class="row mt-sm-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="author-box-details">
                                    <div class="author-box-name">
                                        <a style="pointer-events: none; cursor: default;">{{ $user->name }}</a>
                                    </div>
                                    <div class="author-box-job">{{ Str::title($user->role) }}</div>
                                    <div class="author-box-description">
                                        {{ strip_tags($user->biography) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-7">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form action="{{ url('dashboard/user/'.$user->username) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input name="id" class="form-control" type="text" value="{{ $user->id }}" hidden>
                                    <input name="image_lama" class="form-control" type="string" value="{{ $user->image }}" hidden>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <input name="username" type="text" class="form-control @error('username') is-invalid @enderror" value="{{ $user->username }}" required>
                                            @error('username')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-12">
                                            <label>Role</label>
                                            <select name="role" class="form-control selectric @error('role') is-invalid @enderror" value="{{ $user->role }}" required>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 m-0">
                                            <label>Bio</label>
                                            <textarea name="biography" class="form-control summernote-simple">{{ $user->biography }}</textarea>
                                        </div>
                                    </div>
