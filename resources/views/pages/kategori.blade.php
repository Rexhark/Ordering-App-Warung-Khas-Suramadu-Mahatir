                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <ul class="nav nav-pills" id="kategori-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="by-date-tab" data-toggle="tab" href="#bydatetab"
                                            role="tab" aria-controls="bydate" aria-selected="true">By Date</a>
                                        {{-- <a class="nav-link {{ Request::is('kategori/by-date') ? 'active' : '' }}" href="{{ url('kategori/by-date') }}">By Date</a> --}}
                                    </li>
                                    <li class="nav-item pl-1">
                                        <a class="nav-link" id="by-most-used-tab" data-toggle="tab" href="#bymostusedtab"
                                            role="tab" aria-controls="bymostused" aria-selected="false">By Most Used
                                            Category</a>
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="tab-content no-padding" id="kategori-panel">
                            <div class="tab-pane fade show active" id="bydatetab" role="tabpanel"
                                aria-labelledby="by-date-tab">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="container-fluid row m-0 px-0">
                                                        <a href="{{ url('dashboard/kategori/edit/' . $c1->name) }}"
                                                            class="btn btn-warning col mx-2">Edit</a>
                                                        <button type="button" class="col btn btn-danger mx-2"
                                                            data-toggle="modal"
                                                            data-target="#hapusdata{{ $c1->id }}">Hapus</button>
                                                        {{-- Modal Delete --}}
                                                        <div class="modal fade" id="hapusdata{{ $c1->id }}"
                                                            tabindex="-1" aria-labelledby="hapusdata{{ $c1->id }}"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="hapusdata{{ $c1->id }}">Konfirmasi
                                                                            Hapus Data Kategori</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p>Apakah anda yakin ingin menghapus kategori ini?
                                                                        </p>
                                                                    </div>
                            ...
                            <div class="tab-pane fade" id="bymostusedtab" role="tabpanel"
                                aria-labelledby="by-most-used-tab">
                                <div class="table-responsive">
                                    <table class="table-bordered table-md table">
                                        <tr class="text-center">
                                            <th width="5%">No.</th>
                                        ...
                                        @foreach ($categoryByMostUsed as $c2)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="container-fluid row m-0 px-0">
                                                        <a href="kategori/{{ $c2->name }}"
                                                            class="btn btn-warning col mx-2">Edit</a>
                                                        <button type="button" class="col btn btn-danger mx-2"
                                                            data-toggle="modal"
                                                            data-target="#hapusdata{{ $c2->id }}">Hapus</button>
                                                        {{-- Modal Delete --}}
                                                        <div class="modal fade" id="hapusdata{{ $c2->id }}"
                                                            tabindex="-1" aria-labelledby="hapusdata{{ $c2->id }}"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="hapusdata{{ $c2->id }}">Konfirmasi
                                                                            Hapus Data User</h5>
                                                                        <button type="button" class="close"
                                                                            data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">&times;</span>
