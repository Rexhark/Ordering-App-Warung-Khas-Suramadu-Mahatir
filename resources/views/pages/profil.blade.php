                        ...
                        <div class="card author-box card-primary">
                            <div class="card-body">
                                <div class="author-box-left">
                                    <img alt="image"
                                        src="{{ auth()->user()->image ? asset('storage/' . auth()->user()->image) : asset('img/avatar/avatar-1.png') }}"
                        ...
                        <div class="card author-box card-primary">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="pesanan" class="btn btn-primary">Lihat Semua</a>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <select name="role" class="form-control selectric @error('role') is-invalid @enderror" @if (auth()->user()->role == 'user') disabled @endif>
                                                <option value="admin"
        @if (auth()->user()->role == 'admin') selected @endif>Admin</option>
        ...
        <div class="form-group col-12 m-0 text-center">
            ...
            <div class="d-flex justify-content-center">
                <div id="image-preview" class="image-preview"
                    ...
                    <input name="image" type="file" accept="image/*" id="image-upload"
