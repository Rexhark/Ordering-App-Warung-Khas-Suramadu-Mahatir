...
<ul class="navbar-nav navbar-right">
    <li class="dropdown">
        <a href="#" data-toggle="dropdown" class="flex flex-row nav-link dropdown-toggle nav-link-lg nav-link-user">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            ...
            <a class="dropdown-item">
                <form action="{{ url('dashboard/logout') }}" method="post">
                    @csrf
                    <button type="submit" class="border-0 bg-transparent has-icon text-danger"><i
